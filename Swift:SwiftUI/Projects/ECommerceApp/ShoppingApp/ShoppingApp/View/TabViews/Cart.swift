...
//                                        Alert(title: Text("Thank You!"), message: Text("Your purchse has been successfully completed"), dismissButton: .default(Text("OK")))
//                                }
                            }
                        }
                    }
...
//    func deleteCart(product:Product){
//        sharedData.cartProducts.remove()
//    }
}
